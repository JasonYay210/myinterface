    ...
    const completion = await groq.chat.completions.create({
      messages: [
        ...
        },
        {
          role: 'user',
          content: `
            In the first line, rate the website on a scale of 1-100 based off how standardized it's UI and UX is. 
            Do not include HTML structure as that is associated more with SEO rather than UI/UX.
            Output this rating saying "UI/UX Rating: "
            Analyze the following content based on industry standards for web development, including HTML structure, CSS practices, accessibility. 
            Suggest standardized text and image sizes based on industry data and UX research. 
